...
const useCheckoutSubmit = () => {
  ...
  const handleCouponCode = (e) => {
    ...
    if (total < result[0]?.minimumAmount) {
      ...
      // notifySuccess(
      //   `Your Coupon ${result[0].name} is Applied on ${result[0].productType}!`
      // );
      setCouponApplyMsg(`Your Coupon ${result[0].name} is Applied on ${result[0].productType} productType!`)
