      ...
      <div className="tp-product-thumb-3 tp-product-thumb-top-3  mb-15 fix p-relative z-index-1">
        ...
        <div className="tp-product-action-3 tp-product-action-blackStyle">
          ...
          <Link href={`/product-details/${id}`}>{name}</Link>
                ...
                <label htmlFor="variantSelect" className="variant-label mb-2">
                 <span>Select Variant:</span>
                 <span className="ReviewsAndRatingsMain">
                  <span className="ReviewsAndRatings">
                    <span className="me-1">4.2</span>
                    <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" className="Badges___StyledStarIcon-sc-1k3p1ug-1 qKzFq"><path d="M5.99967 9.23762L3.95958 10.357C3.34224 10.6957 2.93339 10.4129 3.04766 9.7176L3.44489 7.3004L1.78365 5.61036C1.29016 5.10832 1.45737 4.61531 2.15478 4.50955L4.42073 4.16591L5.45629 1.976C5.75639 1.34137 6.24292 1.3413 6.54305 1.976L7.5786 4.16591L9.84456 4.50955C10.543 4.61547 10.71 5.10744 10.2157 5.61036L8.55444 7.3004L8.95168 9.7176C9.06537 10.4095 8.65717 10.6958 8.03975 10.357L5.99967 9.23762Z"></path></svg>
                  </span>
                  <span className="text-secondary ms-1">281 Ratings</span>
                  </span>
                </label>
                <select
                  id="variantSelect"
        ...
        <div className="tp-product-add-cart-btn-large-wrapper">
          {isAddedToCart ? (
            ...
            <div className="addTocard_Btn">
              <div className="mb-4">
                <span> ₹198</span>
                <del className="text-secondary ms-1">₹380</del>
                </div>
